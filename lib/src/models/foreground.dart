...
class MemberUpdateDTO implements Base {
  ...
  MemberUpdateDTO.fromJson(Json json):this(
...
}) => MemberUpdateDTO(     nickname: nickname.absent(this.nickname),
...
class MemberDTO implements Base {
  ...
  MemberDTO.fromJson(Json json):this(
    id: as<int>(json['id']),
...
}) => MemberDTO(     id: id.absent(this.id),
...
class MemberLevelDTO implements Base {
  ...
  MemberLevelDTO.fromJson(Json json):this(
...
}) => MemberLevelDTO(     levelId: levelId.absent(this.levelId),
...
class OAuthDTO implements Base {
  ...
  OAuthDTO.fromJson(Json json):this(
    code: as<String>(json['code']),
    referer: as<int>(json['referer']),
  );
  ...
  OAuthDTO clone({
     ...
     Optional<int>? referer,
}) => OAuthDTO(     code: code.absent(this.code),
...
class TokenDTO implements Base {
  ...
  TokenDTO.fromJson(Json json):this(
  ...
  TokenDTO clone({
     ...
     int? expireIn,
}) => TokenDTO(     token: token ?? this.token,
...
class MemberRegisterDTO implements Base {
  ...
  MemberRegisterDTO.fromJson(Json json):this(
    username: as<String>(json['username']),
...
}) => MemberRegisterDTO(     username: username.absent(this.username),
...
class MobileDTO implements Base {
  ...
  MobileDTO.fromJson(Json json):this(
    mobile: as<String>(json['mobile']),
    agentCode: as<String>(json['agentCode']),
    inviteCode: as<String>(json['inviteCode']),
  ...
  MobileDTO clone({
     ...
     Optional<String>? verifyCode,
}) => MobileDTO(     mobile: mobile.absent(this.mobile),
     agentCode: agentCode.absent(this.agentCode),
     inviteCode: inviteCode.absent(this.inviteCode),
...
class UserPasswordDTO implements Base {
  ...
  UserPasswordDTO.fromJson(Json json):this(
    username: as<String>(json['username']),
    password: as<String>(json['password']),
    verifyCode: as<String>(json['verifyCode']),
  );
  ...
  UserPasswordDTO clone({
     ...
     Optional<String>? password,
     Optional<String>? verifyCode,
}) => UserPasswordDTO(     username: username.absent(this.username),
     password: password.absent(this.password),
     verifyCode: verifyCode.absent(this.verifyCode),
);
...
class BoothDTO implements Base {
  ...
  BoothDTO.fromJson(Json json):this(
...
}) => BoothDTO(     title: title.absent(this.title),
...
class BoothDataDTO implements Base {
  ...
  BoothDataDTO.fromJson(Json json):this(
    type: as<int>(json['type']),
...
}) => BoothDataDTO(     type: type.absent(this.type),
...
class BannerDTO implements Base {
  ...
  BannerDTO.fromJson(Json json):this(
    title: as<String>(json['title'], '')!,
    width: as<int>(json['width']),
    height: as<int>(json['height']),
    extSet: as<Json>(json['extSet']),
    status: as<int>(json['status'], 0)!,
    banners: as<List>(json['banners'])?.map<BannerItemDTO>((e)=>BannerItemDTO.fromJson(e)).toList() ?? [],
  );
...
}) => BannerDTO(     title: title ?? this.title,
...
class BannerItemDTO implements Base {
  ...
  BannerItemDTO.fromJson(Json json):this(
    title: as<String>(json['title'], '')!,
    image: as<String>(json['image'], '')!,
    video: as<String>(json['video'], '')!,
    url: as<String>(json['url']),
    elements: as<List>(json['elements'])?.map<BannerItemElementModel>((e)=>BannerItemElementModel.fromJson(e)).toList(),
...
}) => BannerItemDTO(     title: title ?? this.title,
...
class BannerItemElementModel implements Base {
  ...
  BannerItemElementModel.fromJson(Json json):this(
    image: as<String>(json['image']),
  ...
  BannerItemElementModel clone({
     ...
     Optional<int>? delay,
}) => BannerItemElementModel(     image: image.absent(this.image),
...
class CategoryModel implements Base {
  ...
  CategoryModel.fromJson(Json json):this(
    id: as<int>(json['id']),
    pid: as<int>(json['pid']),
    title: as<String>(json['title']),
...
}) => CategoryModel(     id: id.absent(this.id),
...
class ArticleDTO implements Base {
  ...
  ArticleDTO.fromJson(Json json):this(
    id: as<int>(json['id'], 0)!,
    lang: as<String>(json['lang'], '')!,
...
class CategoryDTO implements Base {
  ...
  CategoryDTO.fromJson(Json json):this(
    id: as<int>(json['id'], 0)!,
    ...
    keywords: as<String>(json['keywords']),
    description: as<String>(json['description']),
    children: as<List>(json['children'])?.map<CategoryDTO>((e)=>CategoryDTO.fromJson(e)).toList(),
  );
...
class OrderItemModel implements Base {
  ...
  OrderItemModel.fromJson(Json json):this(
    column: as<String>(json['column']),
    asc: as<bool>(json['asc']),
  );
  ...
  @override
  OrderItemModel clone({
     Optional<String>? column,
     Optional<bool>? asc,
}) => OrderItemModel(     column: column.absent(this.column),
