...
///
/// {@tool dartpad}
/// This example shows how to trigger [EnhanceRefreshIndicator] in a nested scroll view using
...
///
/// The [EnhanceRefreshIndicator] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [EnhanceRefreshIndicator] will always appear, even if the
...
/// ```
///
/// A [EnhanceRefreshIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
...
class EnhanceRefreshIndicator extends StatefulWidget {
  ...
  /// The offset where [EnhanceRefreshProgressIndicator] starts to appear on drag start.
  ///
  ...
  ///
  /// The [EnhanceRefreshIndicator] can be pulled out in two cases,
...
/// Contains the state for a [EnhanceRefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class EnhanceRefreshIndicatorState extends State<EnhanceRefreshIndicator>
    with TickerProviderStateMixin<EnhanceRefreshIndicator> {
  ...
  @override
  void didUpdateWidget(covariant EnhanceRefreshIndicator oldWidget) {
  ...
  ///
  /// Creating the [EnhanceRefreshIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [EnhanceRefreshIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [EnhanceRefreshIndicator.onRefresh] callback's future completes.
  ///
